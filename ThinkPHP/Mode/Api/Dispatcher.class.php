...
//        $dataSign = json_decode($bodys,true);
//        $actionname = explode('.', $dataSign['actionname']);
//        define('CONTROLLER_NAME',   isset($actionname[1]) ? $actionname[1] : self::getController($varController,$urlCase));
//        define('ACTION_NAME',       isset($actionname[2]) ? $actionname[2] : self::getAction($varAction,$urlCase));
